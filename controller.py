...
class MainController:
    def __init__(self, main_window, ui):
        ...
        self.ui.comboDibujos.addItems(["","Cuadrícula","Estrella","Flor","Tablero","Estrella doble","Circulo"])
    ...
    def set_eraser(self):
        self.canvas.pen_color = QColor("#aeeafc") 
    ...
    def update_pincel(self, width):
        ...
        if figura == "":
            ...
            self.canvas.draw_dstar(width)
        elif figura == "Circulo":
            self.canvas.draw_circulo(width)
        else:
            print("Sin selección")
        ##print(width)
